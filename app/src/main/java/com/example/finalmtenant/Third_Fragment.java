...
//        });
        ...
        tenantdone=view.findViewById(R.id.slideFourDone);
        tenantdone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(view.getContext(), LoginTenant.class);
                startActivity(intent);
            }
        });
